            ...
            <div className="bg-gray-900 rounded-lg p-8 mb-6">
              <div className="text-center mb-6">
                <div className="text-6xl font-bold text-white mb-4">
                  {diceResult !== null ? diceResult.toFixed(2) : '00.00'}
                </div>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-white font-medium">Win Chance: {winChance}%</span>
                  ...
                  <input
                    ...
                    style={{
                      background: rollType === 'under' 
                        ? `linear-gradient(to right, #10b981 0%, #10b981 ${winChance}%, #ef4444 ${winChance}%, #ef4444 100%)`
                        : `linear-gradient(to right, #ef4444 0%, #ef4444 ${100 - winChance}%, #10b981 ${100 - winChance}%, #10b981 100%)`
                    }}
        ...
        <div className="space-y-6">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <button
              ...
              className={`w-full font-semibold py-2 px-4 rounded-lg transition-colors flex items-center justify-center mt-2 ${
                showLiveStats 
